...
do aumento do perc do mesmo.
"""

def aumento_perc(valor, perc):
    return valor + (valor * perc / 100)

ap = aumento_perc(50, 10)
print(ap)
ap = aumento_perc(100, 10)
print(ap)
ap = aumento_perc(10, 10)
print(ap)
ap = aumento_perc(15, 100)
print(ap)
